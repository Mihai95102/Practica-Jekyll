...
![Error]({{ site.url }}/images/practica1/creacion1.png){: .center}
...
![Error]({{ site.url }}/images/practica1/creacion2.png){: .center}
...
![Error]({{ site.url }}/images/practica1/creacion3.png){: .center}
...
![Error]({{ site.url }}/images/practica1/trabajo1.png){: .center}
...
![Error]({{ site.url }}/images/practica1/comprobar3.png){: .center}

Una vez accedemos con nuestro usuario y contraseña podemos ver que tenemos acceso a todas las bases de datos del sistema.

![Error]({{ site.url }}/images/practica1/comprobar4.png){: .center}
...
![Error]({{ site.url }}/images/practica1/comprobar5.png){: .center}

Una vez accedamos podemos ver las estadísticas del servidor.

![Error]({{ site.url }}/images/practica1/comprobar6.png){: .center}