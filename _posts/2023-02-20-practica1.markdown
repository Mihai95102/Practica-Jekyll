...
![Error]({{ site.url }}/images/practica1/creacion1.png){: .center}{:width="350px"}
...
![Error]({{ site.url }}/images/practica1/creacion2.png){: .center}{:width="350px"}
...
![Error]({{ site.url }}/images/practica1/creacion3.png){: .center}{:width="350px"}
...
![Error]({{ site.url }}/images/practica1/comprobar1.png){: .center}{:width="350px"}

Una vez accedemos con nuestro usuario y contraseña podemos ver que tenemos acceso a todas las bases de datos del sistema.

![Error]({{ site.url }}/images/practica1/comprobar2.png){: .center}{:width="350px"}
...
![Error]({{ site.url }}/images/practica1/comprobar3.png){: .center}{:width="350px"}

Una vez accedemos con nuestro usuario y contraseña podemos ver que tenemos acceso a todas las bases de datos del sistema.

![Error]({{ site.url }}/images/practica1/comprobar4.png){: .center}{:width="350px"}
...
![Error]({{ site.url }}/images/practica1/comprobar5.png){: .center}{:width="350px"}

Una vez accedamos podemos ver las estadísticas del servidor.

![Error]({{ site.url }}/images/practica1/comprobar6.png){: .center}{:width="350px"}